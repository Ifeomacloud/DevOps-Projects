...
- A Security Group (my-SG) with these inbound rules:
...
```bash
cd Downloads/
ssh -i mykey.pem ubuntu@13.48.133.133
```

**Reason**: This command securely connects your local machine to the EC2 instance using your SSH key.
cd ... → go to the folder where your key file (mykey.pem) is stored
...
-Method: POST
-URL: http://3.82.128.66:5000/api/todos
...
- Method: DELETE
- URL: http://3.82.128.66:5000/api/todos/68a24a1af925444a201a51d7
...
```json
{
  ...
  "author": "IFEOMA QUEENDALINE OKOYE",
  "license": "ISC",
  "description": "",
  "dependencies": {
    "dotenv": "^17.2.1",
